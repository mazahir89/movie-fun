...
public class HomeController {
    ...
    public HomeController(MoviesBean moviesBean, AlbumsBean albumsBean, MovieFixtures movieFixtures, AlbumFixtures albumFixtures, PlatformTransactionManager platformTransactionManagerMovies, PlatformTransactionManager platformTransactionManagerAlbums) {
    ...
    public String setup(Map<String, Object> model) {
        transactionTemplateMovies.execute(
                (status) -> {
        ...
        transactionTemplateAlbums.execute(
                (status) -> {
